...
function setUpNlp() {
    ...
    // create loop
    {
        ...
        nlp.addDocument(
            'Create a for loop for {create_loop_counts} counts',
            'create_loop'
        );

        nlp.addDocument(
            'Create a loop with {create_loop_counts} counts',
            'create_loop'
        );
    ...
    // create while
    {
        ...
        // train with some examples
        nlp.addDocument(
            'Create a while with {create_loop_counts}',
            'create_while'
        );
	
	nlp.addDocument(
            'Create a while {create_loop_counts}',
            'create_while'
        );

	nlp.addDocument(
            'while with {create_loop_counts}',
            'create_while'
        );

        // test it
        showResults(nlp.test('create a while with 100'));
        showResults(nlp.test('while with 20'));
    }
    ...
    // if_else
    {
        ...
        nlp.addDocument(
            'if beta equals one and x equals zero',
            'if_condition',
            { fromFullSentence: true, expandIntent: true },
        )
        ...
        showResults(nlp.test('if beta equals one and x equals two'))
    }
